      ...
      <SvgContainer $isRtl={isRtl}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080" preserveAspectRatio="xMidYMid slice">
          ...
          <g className="animated-content">
            <svg x="435" y="390" width="280" height="280" viewBox="-40 -40 580 580" style={{ overflow: 'visible' }}>
              <defs>
              ...
              <circle cx="250" cy="250" r="252" fill="none" stroke={theme.colors.accent} strokeWidth="6" filter="url(#photo-glow)" opacity="0.8" />
              <image href="/profile-photo.jpg" width="500" height="500" clipPath="url(#circle-clip)" preserveAspectRatio="xMidYMid slice" />
            </svg>
