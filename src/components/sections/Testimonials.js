...
const getInitials = (name) => {
  ...
  // If the name starts with a year (e.g. 2024 Phase 1), show '24
  if (parts[0].length === 4 && !isNaN(parts[0])) return `'${parts[0].substring(2)}`;
...
const Testimonials = () => {
  ...
  useEffect(() => {
    ...
    // Draw { AHK } logo to offscreen canvas for particles
    octx.save();
    ...
    octx.beginPath();
    octx.moveTo( -180, -150 );
    octx.bezierCurveTo( -220, -150, -230, -130, -230, -70 );
    octx.lineTo( -230, -40 );
    octx.bezierCurveTo( -230, -10, -250, 0, -280, 0 );
    octx.bezierCurveTo( -250, 0, -230, 10, -230, 40 );
    octx.lineTo( -230, 70 );
    octx.bezierCurveTo( -230, 130, -220, 150, -180, 150 );
    octx.stroke();
    ...
    octx.font = '900 160px "Space Grotesk", sans-serif';
    octx.textAlign = 'center';
    octx.textBaseline = 'middle';
    octx.fillText('AHK', 0, 10);
