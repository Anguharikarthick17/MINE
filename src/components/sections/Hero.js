...
export default function Hero() {
  ...
  /* ── 12 Badges Config ── */
  const BADGES = [
    { name: 'Prompt Engineering', emoji: '⭐', color: '#fbbf24', percent: '95%' },
    { name: 'HTML', emoji: '🌐', color: '#E34F26', percent: '90%' },
    { name: 'CSS', emoji: '🎨', color: '#1572B6', percent: '85%' },
    { name: 'JavaScript (Basic)', emoji: '📜', color: '#F7DF1E', percent: '60%' },
    { name: 'Python', emoji: '🐍', color: '#3776AB', percent: '55%' },
    { name: 'Java', emoji: '☕', color: '#007396', percent: '50%' },
    { name: 'C', emoji: '💻', color: '#A8B9CC', percent: '45%' },
    { name: 'Responsive Design', emoji: '📱', color: '#00D8FF', percent: '85%' },
    { name: 'UI/UX Basics', emoji: '🖌️', color: '#F24E1E', percent: '70%' },
    { name: 'Problem Solving', emoji: '🧩', color: '#FF3366', percent: '80%' },
  ];
      ...
      <HeroContainer>
        ...
        <TextColumn ref={textColumnRef}>
          ...
          <HeroActions>
            <PrimaryBtn
              href="#achievements"
              onClick={(e) => { e.preventDefault(); scrollTo('achievements'); }}
          ...
          <SocialLinks>
            <SocialIcon href="https://github.com/Anguharikarthick17" target="_blank" rel="noopener noreferrer"><FiGithub /></SocialIcon>
            <SocialIcon href="https://www.linkedin.com/in/angu-hari-karthick-m-175753374/" target="_blank" rel="noopener noreferrer"><FiLinkedin /></SocialIcon>
            <SocialIcon href="https://www.instagram.com/ahk.7teen/" target="_blank" rel="noopener noreferrer"><FiInstagram /></SocialIcon>
          </SocialLinks>
        </TextColumn>
